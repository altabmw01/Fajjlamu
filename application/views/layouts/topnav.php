    ...
    <nav class="" role="navigation">
        ...
        <ul class="nav navbar-nav navbar-right">
            <?php if ($this->ion_auth->in_group('Admin')) { ?>
                ...
                <li><a href="<?php __menu('systemsettings'); ?>"><i class="fa fa-cog fa-fw"></i>&nbsp;System
                        Settings</a></li>
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle" aria-expanded="false" data-toggle="dropdown"
                       href="javascript:;"><i
                            class="fa fa-cog fa-fw"></i>&nbsp;Pages Manager</a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php __menu('addnewpage'); ?>">Add New</a></li>
                        <li><a href="<?php __menu('viewpages'); ?>">All Pages</a></li>
                        <li><a href="<?php __menu('frontmenus'); ?>">View Menus</a></li>
                        <li><a href="<?php __menu('addfrontmenu'); ?>">Add Menus</a></li>
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php __menu('promotion_manager'); ?>">Student Promotion Manager</a></li>
                        <li><a href="<?php __menu('tools'); ?>">Tools</a></li>
                        <li><a href="<?php __menu('sendticket'); ?>">Send a support ticket</a></li>
                        <li><a href="<?php __menu('backupmanager'); ?>">Take a backup</a></li>
                        <li><a href="<?php __menu('aboutsmart'); ?>">About Smart Campus</a></li>
                        <li><a href="<?php __menu('aboutideatweaker'); ?>">About Idea Tweaker</a></li>
                    </ul>
                </li>
            <?php } ?>
            <li class="">
