<div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12">
        ...
        <input name="infosid" type="hidden" value="<?php __e((isset($userinformation->InfosId) ? $userinformation->InfosId : 'none')); ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $data = array(
                    ...
                    'data-minlength' => '2',
                    'required' => 'required',
                    'value' => (isset($userinformation->BloodGroup) ? $userinformation->BloodGroup : '')
                );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $data = array(
                    ...
                    'data-minlength' => '2',
                    'required' => 'required',
                    'value' => (isset($userinformation->Religion) ? $userinformation->Religion : '')
                );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $data = array(
                    ...
                    'data-minlength' => '2',
                    'required' => 'required',
                    'value' => (isset($userinformation->Upazila) ? $userinformation->Upazila : '')
                );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $data = array(
                    ...
                    'data-minlength' => '2',
                    'required' => 'required',
                    'value' => (isset($userinformation->District) ? $userinformation->District : '')
                );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                $data = array(
                    ...
                    'data-minlength' => '2',
                    'required' => 'required',
                    'value' => (isset($userinformation->JoinDate) ? $userinformation->JoinDate : '')
                );
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php
                echo form_dropdown('enrollmentstatus', $enrollment, set_value('gender', (isset($userinformation->EnrollmentStatus) ? $userinformation->EnrollmentStatus : ''), TRUE), array('class' => 'form-control'));
                ?>
            </div>
        </div>
