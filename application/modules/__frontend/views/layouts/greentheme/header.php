        ...
        <div class="banner">
            <a href="<?php __e(base_url()); ?>">
                <img src="<?php __e(base_url() . 'uploads/settings/' . $settings->InstituteLogo); ?>" alt="">
                    <span>
                        <em><?php __e((isset($settings->InstituteName) ? $settings->InstituteName : 'Powered by Smart Campus')); ?></em>
                    </span>

                <div class="clearfix"></div>
                <i><?php __e((isset($settings->InstituteEIIN) ? 'ইআইআইএন নং - ' . $settings->InstituteEIIN : 'Update EIIN')); ?></i>
            </a>
        </div>
        <div class="funderhistory">
            <a href="http://www.pakutiacollege.edu.bd/page/founder-history">
